...
class data_to_vsg(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.freq_tx = freq_tx = 905e6
        self.freq_rx = freq_rx = 920e6

        ##################################################
        # Blocks
        ##################################################
        self.vsg60_iqin_1 = vsg60.iqin(freq_tx, 0, samp_rate, False)
        ...
        self.soapy_bladerf_source_1.set_bandwidth(0, 0.0)
        self.soapy_bladerf_source_1.set_frequency(0, freq_tx)
        self.soapy_bladerf_source_1.set_frequency_correction(0, 0)
        self.soapy_bladerf_source_1.set_gain(0, min(max(30, -1.0), 60.0))
        ...
        self.soapy_bladerf_sink_1.set_frequency(0, freq_rx)
        self.soapy_bladerf_sink_1.set_frequency_correction(0, 0)
        self.soapy_bladerf_sink_1.set_gain(0, min(max(40, 17.0), 73.0))
        ...
        self.blocks_file_source_1 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/empire/Documents/InternProj2025/Final_Product/transmitter/data_for_sighound.bin', True, 0, 0)
        ...
        self.connect((self.blocks_throttle_1, 0), (self.vsg60_iqin_1, 0))
        self.connect((self.blocks_throttle_2, 0), (self.soapy_bladerf_sink_1, 0))
        self.connect((self.soapy_bladerf_source_1, 0), (self.blocks_throttle_2, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.vsg60_iqin_1.set_srate(self.samp_rate)
    ...
    def set_freq_tx(self, freq_tx):
        ...
        self.soapy_bladerf_source_1.set_frequency(0, self.freq_tx)
        self.vsg60_iqin_1.set_frequency(self.freq_tx)
    ...
    def set_freq_rx(self, freq_rx):
        ...
        self.soapy_bladerf_sink_1.set_frequency(0, self.freq_rx)
