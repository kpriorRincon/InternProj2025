...
class data_to_vsg(gr.top_block):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/empire/Documents/InternProj2025/Experimentation/hardware/CRC_Testing/data_for_sighound.bin', True, 0, 0)
