 ...
 * 
 * Additions made by: Trevor Wiseman
 */
...
corr_est_cc::sptr corr_est_cc::make(float sps,
                                    unsigned int mark_delay,
                                    float threshold,
                                    tm_type threshold_method)
{
    return gnuradio::make_block_sptr<corr_est_cc_impl>(
        sps, mark_delay, threshold, threshold_method);
}

corr_est_cc_impl::corr_est_cc_impl(float sps,
                                   unsigned int mark_delay,
                                   float threshold,
                                   tm_type threshold_method)
