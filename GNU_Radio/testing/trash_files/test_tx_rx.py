...
class test_tx_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "QPSK Equalizer Sim", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QPSK Equalizer Sim")
        ...
        self.var_adapt_alg = var_adapt_alg = digital.adaptive_algorithm_cma( qpsk, .0001, sps).base()
        ...
        self._noise_volt_range = Range(0, 1, .01, .2, 200)
        ...
        self._freq_offset_range = Range(-.1, .1, .001, 0.025, 200)
        ...
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(sps, phase_bw, rrc_taps, nfilts, 16, 1.5, 2)
        self.digital_map_bb_0 = digital.map_bb([0, 1, 3, 2])
        self.digital_linear_equalizer_0 = digital.linear_equalizer(15, 2, var_adapt_alg, True, [ ], 'corr_est')
        self.digital_diff_decoder_bb_0 = digital.diff_decoder_bb(sps, digital.DIFF_DIFFERENTIAL)
        self.digital_costas_loop_cc_0 = digital.costas_loop_cc(phase_bw, sps, False)
        self.digital_constellation_modulator_0_3 = digital.generic_mod(
            constellation=qpsk,
            differential=True,
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/trevorwiseman/Documents/rincon/testing/bits_to_send.char', False, 0, 4)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/trevorwiseman/Documents/rincon/testing/bits_read_in.char', False)
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_file_source_0, 0), (self.digital_constellation_modulator_0_3, 0))
        ...
        self.connect((self.digital_constellation_modulator_0_3, 0), (self.blocks_throttle_0, 0))
    ...
    def get_var_adapt_alg(self):
        return self.var_adapt_alg

    def set_var_adapt_alg(self, var_adapt_alg):
        self.var_adapt_alg = var_adapt_alg
