...
class blade_rf_repeat(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "blade_rf_repeat")
        ...
        self.soapy_bladerf_sink_0.set_gain(0, min(max(30, 17.0), 73.0))
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_complex_to_float_0, 1), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.blocks_complex_to_float_0, 0), (self.qtgui_time_sink_x_0_0, 0))
        self.connect((self.soapy_bladerf_source_0, 0), (self.blocks_complex_to_float_0, 0))
...
def main(top_block_cls=blade_rf_repeat, options=None):
