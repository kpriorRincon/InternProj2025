...
class qpsk_signal_processing(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, user_vector):
        ...
        self.input_vector = input_vector = user_vector
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_c(input_vector, True, 1, [])
    ...
    def set_input_vector(self, input_vector):
        ...
        self.blocks_vector_source_x_0.set_data(self.input_vector, [])
