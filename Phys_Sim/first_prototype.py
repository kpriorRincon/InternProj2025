...
import Receiver as Receiver # Use demod from here
...
def main():
    ...
    receiver = Receiver.Receiver(sampling_rate=fs_sampling)
    ...
    #analytic_sig, bits = receiver.demodulator(qpsk, fs_sampling, symbol_rate, f_carrier)    
    ...
    #analytic_sig, bits = receiver.demodulator(qpsk_mixed, fs_sampling, symbol_rate, f_carrier)    
