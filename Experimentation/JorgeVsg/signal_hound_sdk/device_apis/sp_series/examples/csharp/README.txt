The sp_api.cs source file contains the sp_api class, which acts as an interface to the SP API.
The methods provided in the sp_api class have one-to-one mappings to the C functions provided by our C++ header file.
...
The sp_example.cs source file contains a method which exercises the sp_api class.
...
"An unhandled exception of type 'System.BadImageFormatException' occurred in csharp_sp_api.exe"
